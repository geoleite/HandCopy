 ...
 * @author geoleite
 */
public class Rel_UsuariosRequisicoes extends RelatorioPortal implements INotSecurity {
    ...
    public void imprimir() {
        try {
            ...
            if (!getTipo().equalsIgnoreCase("XLS")) {
                is = Rel_TicketSolicitacao.class.getResourceAsStream("usuariosRequisicoes.jasper");
            }
