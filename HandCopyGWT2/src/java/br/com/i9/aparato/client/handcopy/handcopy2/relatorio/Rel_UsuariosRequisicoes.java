 ...
 * @author geoleite
 */
public class Rel_UsuariosRequisicoes extends RelatorioBaseGWT{
    public Rel_UsuariosRequisicoes() {
        setHeading("Usuarios Requisicoes");
        setSize(750, 400);

        //download(Constantes.URL + "handcopy/handcopy2/relatorio/usuariosRequisicoes.jsp?op=imprimir&tipo=PDF");
        filtrar();
    }


    public String getURL() {
        return "handcopy/handcopy2/relatorio/usuariosRequisicoes.jsp?op=imprimir";
    }
